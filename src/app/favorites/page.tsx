...
export default function FavoritesPage() {
  const { currentMode, favoriteData, setFavoriteData, historyData } =
    useAppStore();
    ...
    <div className="space-y-3 pb-24">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full bg-white dark:bg-white/5 text-gray-900 border-none dark:text-white rounded-full pl-11 pr-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-red-500/50 shadow-sm transition-shadow"
          placeholder="在收藏中搜索..."
        />
      </div>
