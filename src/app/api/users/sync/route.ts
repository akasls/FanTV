...
export async function POST(req: NextRequest) {
  try {
    ...
    if (doubanDataProxy !== undefined)
      updateData.doubanDataProxy = doubanDataProxy;
    if (doubanImageProxy !== undefined)
      updateData.doubanImageProxy = doubanImageProxy;
    if (speedTestPlayback !== undefined)
      updateData.speedTestPlayback = speedTestPlayback;
